...
namespace ChallengeHeroMonstaerClassOne
{
    public partial class Default : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            hero.Name = "General Disarray";
            hero.Health = 100;
            hero.DamageMaximum = 30;
            hero.AttackBonus = false;

            Character monster = new Character();
            monster.Name = "Professor Chaos";
            monster.Health = 100;
        ...
        {
            resultLabel.Text += String.Format("<p>Name:{0}</br> Health{1}<br/> Damage Maximum{2} <br/> Attack Bonus{3}</p>", 
                character.Name, 
                character.Health, 
